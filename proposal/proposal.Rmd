...
For my third test, I made a small modification to an existing geom creating `geom_tile_new`. In this geom, the `geom_tile` defaults have been modified and the deocumention was also updates to follow the modifications. 
